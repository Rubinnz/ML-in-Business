...
CREATE TABLE `hoadon` (
  ...
  `ghichu` varchar(5000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `hoadon` VALUES (1,'HD1','2025-01-01 00:00:00',1,2,1,'Đã thanh toán'),(2,'HD2','2025-02-02 00:00:00',1,1,1,'Đã thanh toán'),(3,'HD3','2025-01-02 00:00:00',1,1,1,'Đã thanh toán');
