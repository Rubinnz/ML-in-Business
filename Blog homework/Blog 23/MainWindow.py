# Form implementation generated from reading ui file 'C:\Tiêu Đăng Vinh\Học máy trong kinh doanh\K22416C\Blog homework\Blog 23\MainWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:\\Tiêu Đăng Vinh\\Học máy trong kinh doanh\\K22416C\\Blog homework\\Blog 23\\images/logo.jpg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("C:\\Tiêu Đăng Vinh\\Học máy trong kinh doanh\\K22416C\\Blog homework\\Blog 23\\images/delete.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("C:\\Tiêu Đăng Vinh\\Học máy trong kinh doanh\\K22416C\\Blog homework\\Blog 23\\images/save.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("C:\\Tiêu Đăng Vinh\\Học máy trong kinh doanh\\K22416C\\Blog homework\\Blog 23\\images/new.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "QTableWidget"))
